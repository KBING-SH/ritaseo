  ...
  return (
    <div className="min-h-screen bg-background transition-colors duration-300">
      ...
      <section className="h-[calc(100vh-3.5rem)] flex">
        ...
        {/* Right: hero content */}
        <div className="flex-1 min-w-0 flex flex-col px-4 md:px-6 pt-3 md:pt-4 pb-3 md:pb-4">
          {/* Mobile: show UploadPanel inline */}
          <div className="lg:hidden mb-4">
            <UploadPanel />
          </div>

          <div className="text-center shrink-0 mt-4 md:mt-6 mb-4 md:mb-6">
          ...
          <div className="w-[71.5%] mx-auto aspect-[16/9] rounded-2xl overflow-hidden">
            <StyleSelector />
          </div>
        </div>
      </section>
